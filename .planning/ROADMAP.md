...
- [ ] **Phase 1: Tool Parity & LLM Router** - Bring Flame tools to projekt-forge parity and promote llm_router.py to a production async package
...
|-------|----------------|--------|-----------|
| 1. Tool Parity & LLM Router | 0/TBD | Not started | - |
