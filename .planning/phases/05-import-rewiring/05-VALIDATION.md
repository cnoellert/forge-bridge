...
| 5-04-01 | 04 | D | RWR-04 | — | conftest site-packages autouse fixture present + passing on every pytest run | unit | `grep -q 'def assert_forge_bridge_from_site_packages' /Users/cnoellert/Documents/GitHub/projekt-forge/tests/conftest.py` AND `cd /Users/cnoellert/Documents/GitHub/projekt-forge && pytest -q --no-header -k "test_" 2>&1 \| tail -1 \| grep -qE "passed\|no tests ran"` (autouse fires on every session; failure short-circuits suite) | ⬜ W0 | ⬜ pending |
