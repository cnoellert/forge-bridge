...
def test_segment_split_is_a_live_proven_commit_only_counterpart():
...
def test_sequence_marker_is_a_live_proven_commit_only_counterpart():
...
def test_segment_marker_is_a_live_proven_commit_only_counterpart():
...
def test_transition_is_held_out_of_commit_admission_before_live_proof():
